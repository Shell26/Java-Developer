...
1) Принцип единственной ответственности (SRP) <br>
...
2)Принцип открытости/закрытости (OCP)<br>
...
3)Принцип подстановки Барбары Лисков (LSP)<br>
...
4)ринцип разделения интерфейса (ISP)<br>
...
5)Принцип инверсии зависимостей (DIP)<br>
